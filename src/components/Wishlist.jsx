...
const Wishlist = ({ wishlist, handleRemoveWish }) => {
    const { product_title, product_image, price, product_id, description } = wishlist;
    ...
    return (
        <div className="w-11/12 md:w-4/5 border-2 mb-3 mx-auto bg-base-100 shadow-xl flex flex-col md:flex-row gap-4 md:gap-8 rounded-lg p-4 md:p-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center w-full gap-4">
                ...
                <div onClick={() => handleRemoveWish(product_id)} className="flex justify-center md:justify-end w-full md:w-auto mt-4 md:mt-0">
